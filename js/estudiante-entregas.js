...
document.addEventListener("DOMContentLoaded", () => {
    ...
    formEntrega.addEventListener("submit", async (e) => {
      ...
      try {
        // Ajustamos la URL para que coincida con la ruta configurada en el backend.
        const res = await fetch('http://localhost:3005/api/entregas', {
          method: 'POST',
          headers: {
